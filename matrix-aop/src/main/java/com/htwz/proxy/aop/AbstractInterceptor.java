...
import com.htwz.proxy.exception.ProxyException;
...
public abstract class AbstractInterceptor implements MethodInterceptor {
    ...
    private boolean isCglibAopProxy(MethodInvocation invocation) {
        return getProxyClassName(invocation).contains(ProxyConstant.CGLIB);
    }

    protected String getProxyType(MethodInvocation invocation) {
    ...
    private Class<?> getProxyClass(MethodInvocation invocation) {
        return invocation.getClass();
    }

    private String getProxyClassName(MethodInvocation invocation) {
        return getProxyClass(invocation).getCanonicalName();
    }

    private Object getProxiedObject(MethodInvocation invocation) {
        return invocation.getThis();
    }

    private Class<?> getProxiedClass(MethodInvocation invocation) {
        return getProxiedObject(invocation).getClass();
    }

    protected String getProxiedClassName(MethodInvocation invocation) {
    ...
    private Annotation[][] getMethodParameterAnnotations(MethodInvocation invocation) {
        return getMethod(invocation).getParameterAnnotations();
    }

    private Class<?>[] getMethodParameterTypes(MethodInvocation invocation) {
        return getMethod(invocation).getParameterTypes();
    }

    private String getMethodParameterTypesValue(MethodInvocation invocation) {
     ...
     * 获取变量名
     */
    private String[] getMethodParameterNames(MethodInvocation invocation) {
     ...
     * @return
     */
    protected String getSpelKey(MethodInvocation invocation, String key) {
